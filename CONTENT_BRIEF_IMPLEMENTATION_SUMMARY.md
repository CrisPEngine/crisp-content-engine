...
- ✅ `primary_goal` (Single Select: Awareness | Engagement | Traffic | Leads, optional)
- ✅ `success_metric` (Single Select: CTR | comments | followers | leads, optional)
- ✅ `cta` (Text, optional)
- ✅ `cta_link` (URL, optional)
- ✅ `offers_to_push` (Long Text, optional)
- ✅ `topics_to_avoid_this_month` (Long Text, optional)
- ✅ `competitor_or_inspo_links` (Long Text, optional)
