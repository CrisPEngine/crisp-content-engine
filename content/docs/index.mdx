...
- **Native publishing**: LinkedIn (stable), Meta (Facebook + Instagram) behind a feature flag.
- **Export-only**: X and Blog (copy/paste workflow).

<Callout type="note">
Meta publishing is **feature-flag gated** and should not be enabled in production until the Meta app is approved.
</Callout>
