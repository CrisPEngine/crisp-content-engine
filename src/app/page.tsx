...
function HeroContent() {
  ...
  return (
    <div className="relative z-10 max-w-2xl">
      <motion.h1 
        className="text-5xl font-semibold tracking-tight sm:text-6xl lg:text-7xl leading-tight"
      ...
      <motion.p 
        className="mt-5 max-w-xl text-lg leading-relaxed text-neutral-300 sm:text-xl"
        initial={shouldReduceMotion ? {} : { opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: 0 }}
  ...
  return (
    ...
    >
      <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-neutral-900/60 via-neutral-900/40 to-neutral-900/20 p-10 ring-1 ring-neutral-800/50 backdrop-blur-xl lg:p-14">
        ...
        <motion.div 
          className="mt-10 text-center pb-4"
          initial={shouldReduceMotion ? {} : { opacity: 0 }}
